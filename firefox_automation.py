...
if __name__ == '__main__':
    ...
    # options.add_experimental_option('excludeSwitches', ['enable-logging'])  # to remove logging error messages in stdout  -- not working with firefox
    ...
    py -3 firefox_automation.py -x <webdriver_executable_path> -u <username> -p <password> -n <card_number> -m <card_month> -y <card_year> -c <card_cvv> -d <phone_number> -e <test_email>
    '''