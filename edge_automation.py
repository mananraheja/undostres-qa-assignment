...
if __name__ == '__main__':
    ...
    # options = webdriver.EdgeOptions() -- doesn't work
    ...
    py -3 edge_automation.py -x <webdriver_executable_path> -u <username> -p <password> -n <card_number> -m <card_month> -y <card_year> -c <card_cvv> -d <phone_number> -e <test_email>
    '''
